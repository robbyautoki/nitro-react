...
export const NameChangeInitView:FC<NameChangeLayoutViewProps> = props =>
{
    ...
    return (
        <div className="flex flex-col gap-4 h-full">
            ...
            <div className="font-bold flex items-center justify-center h-full w-full">{ LocalizeText('tutorial.name_change.current', [ 'name' ], [ GetSessionDataManager().userName ]) }</div>

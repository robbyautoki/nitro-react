...
const CHAT_COMMANDS: { command: string, description: string, minRank: number, category: string }[] = [
    ...
    { command: ':pet activate', description: 'Pet als Begleiter aktivieren [Name]', minRank: 0, category: 'Allgemein' },
    { command: ':pet deactivate', description: 'Begleiter-Pet deaktivieren', minRank: 0, category: 'Allgemein' },
    { command: ':pet', description: 'Begleiter-Pet Status anzeigen', minRank: 0, category: 'Allgemein' },

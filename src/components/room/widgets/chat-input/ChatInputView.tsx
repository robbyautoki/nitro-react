...
const CHAT_COMMANDS: ChatCommand[] = [
    ...
    { command: ':glow', description: 'Möbel-Glow setzen (furni_id farbe)', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },
    { command: ':glow pulse', description: 'Pulsierender Glow (furni_id farbe)', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },

...
const DEMO_COMMANDS: ChatCommand[] = [
  ...
  { command: ":jail zone add", description: "Jail-Zone speichern", minRank: 14, category: "Moderator", params: [{ name: "typ", type: "text" }, { name: "key", type: "text" }, { name: "radius", type: "number" }] },

...
const CHAT_COMMANDS: ChatCommand[] = [
    ...
    { command: ':casino', description: 'Casino-Info im aktuellen Raum', minRank: 0, category: 'Allgemein' },
    { command: ':casino stats', description: 'Casino-Statistik (Owner)', minRank: 0, category: 'Allgemein' },
    { command: ':casino limits', description: 'Min/Max Bet anzeigen', minRank: 0, category: 'Allgemein' },
    { command: ':casino setlimit', description: 'Min/Max Bet setzen (Owner)', minRank: 0, category: 'Allgemein', params: [{ name: 'min', type: 'number' }, { name: 'max', type: 'number' }] },
    { command: ':bet', description: 'Eigene Wett-Statistik anzeigen', minRank: 0, category: 'Allgemein' },
    ...
    { command: ':bail', description: 'Spieler gegen Diamanten freikaufen', minRank: 1, category: 'Allgemein', params: [{ name: 'username', type: 'user' }] },
    { command: ':bail self', description: 'Sich selbst gegen Diamanten freikaufen', minRank: 1, category: 'Allgemein' },
    { command: ':bail price', description: 'Bail-Preis abfragen', minRank: 1, category: 'Allgemein', params: [{ name: 'username', type: 'user' }] },
    { command: ':knast_shop', description: 'Knast-Shop öffnen', minRank: 1, category: 'Allgemein' },
    { command: ':knast_shop list', description: 'Shop-Items als Liste', minRank: 1, category: 'Allgemein' },
    { command: ':knast_shop buy', description: 'Item kaufen (Zigaretten)', minRank: 1, category: 'Allgemein', params: [{ name: 'item_key', type: 'text' }] },
    { command: ':knast_shop bonus', description: 'Tagesbonus einlösen', minRank: 1, category: 'Allgemein' },
    { command: ':knast_rang', description: 'Eigenes Knast-Profil anzeigen', minRank: 1, category: 'Allgemein' },
    { command: ':zigaretten', description: 'Zigaretten-Bilanz anzeigen', minRank: 1, category: 'Allgemein' },
    { command: ':spotlight', description: 'Aktive Spotlights deines Raums anzeigen', minRank: 1, category: 'Allgemein' },
    { command: ':spotlight info', description: 'Verbleibende Zeit deiner Spotlights', minRank: 1, category: 'Allgemein' },
    { command: ':spotlight activate', description: 'Spotlight für Raum aktivieren (Admin)', minRank: 6, category: 'Admin' },
    { command: ':spotlight deactivate', description: 'Spotlight für Raum deaktivieren (Admin)', minRank: 6, category: 'Admin' },
    ...
    { command: ':glow', description: 'Neon Glow (furni_id farbe)', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },
    { command: ':glow neon', description: 'Neon Outer Glow', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },
    { command: ':glow rainbow', description: 'Regenbogen Glow', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }] },
    { command: ':glow fire', description: 'Feuer/Flammen Effekt', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },
    { command: ':glow sparkle', description: 'Glitzer/Funken Effekt', minRank: 15, category: 'Admin', params: [{ name: 'furni_id', type: 'number' }, { name: 'farbe', type: 'text' }] },

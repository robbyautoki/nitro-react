        ...
        <Column gap={ 2 } className="wordquiz-question p-2">
            { !canVote &&
                <Flex fullWidth alignItems="center" gap={ 2 }>
                    <Flex center pointer className="bg-red-500 rounded p-2">
                        <Text variant="white">{ noVotes }</Text>
                    </Flex>
                    <Text variant="white" center textBreak>{ question }</Text>
                    <Flex center pointer className="bg-green-500 rounded p-2">
            ...
            { canVote &&
                <Column>
                    ...
                    <Flex fullWidth justifyContent="center" gap={ 1 }>
                        <Flex center pointer className="bg-red-500 rounded p-1" onClick={ event => vote(VALUE_KEY_DISLIKE) }>
                            <Base className="word-quiz-dislike" />
                        </Flex>
                        <Flex center pointer className="bg-green-500 rounded p-1" onClick={ event => vote(VALUE_KEY_LIKE) }>

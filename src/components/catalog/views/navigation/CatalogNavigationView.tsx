...
export const CatalogNavigationView: FC<CatalogNavigationViewProps> = ({ staffView = false }) =>
{
        ...
        if(hasChildren)
        {
            ...
            return (
                <div key={ index } className={ index > 0 ? 'mt-0.5' : '' }>
                    <button
                        className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 transition-colors hover:bg-bg-white-0"
                        onClick={ () => 
                        {
    ...
    return (
        <div className="flex-1 overflow-y-auto" style={ { scrollbarWidth: 'thin' } }>
            ...
            { staffView && (
                <div className="shrink-0 border-b border-warning-base/20 bg-warning-lighter px-3 py-2">
                    <div className="flex items-center gap-2 text-label-xs text-warning-base">
                    ...
                    { favorites.length > 0 && rootNode && <>
                        <div>
                            <div className="px-3 pt-2 pb-1.5">
                                <span className="flex cursor-pointer select-none items-center gap-1.5 text-subheading-2xs uppercase text-warning-base"
                        ...
                        <Divider.Root className="mx-3 my-1.5" />
                    </> }

...
export const CatalogLayoutRoomAdsView: FC<CatalogLayoutProps> = props =>
{
    ...
    return (
        <div className="flex flex-col h-full gap-2 overflow-auto">
            <span className="text-sm font-semibold text-black/85 text-center">{ LocalizeText('roomad.catalog_header') }</span>
            <span className="text-xs text-black/50">{ LocalizeText('roomad.catalog_text', [ 'duration' ], [ '120' ]) }</span>
            <div className="flex flex-col gap-2 rounded-lg bg-black/[0.03] border border-black/[0.06] p-3">
                <div className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-black/85">{ LocalizeText('navigator.category') }</span>
                ...
                <div className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-black/85">{ LocalizeText('roomad.catalog_name') }</span>
                ...
                <div className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-black/85">{ LocalizeText('roomad.catalog_description') }</span>
                ...
                <div className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-black/85">{ LocalizeText('roomad.catalog_roomname') }</span>

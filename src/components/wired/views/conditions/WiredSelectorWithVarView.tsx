...
export const WiredSelectorWithVarView: FC<{}> = () =>
{
    ...
    const save = () => { setStringParam(variableName); setIntParams([ filterExisting ? 1 : 0, invert ? 1 : 0 ]); };
    ...
    return (
        <WiredSelectorBaseView title="With Variable" hasSpecialInput={ true } save={ save } showOptions={ false }>
            <Column gap={ 1 }>
